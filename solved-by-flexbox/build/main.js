...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__supports__ = __webpack_require__(0);


var POLYFILL_PATH = "/" + 'polyfills.js';
...
function main(err) {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_0__supports__["a" /* default */].flexbox()) {
  ...
  __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 1)).then(function (analytics) {
    analytics.init();
    if (err) {
