...
<head>
    ...
    <meta name="description" content="Omnifodd is a premium food delivery service with the mission to bring affordable and healthy meals to as many people as possible" />
    ...
    <!-- <link href="vendors/css/onepage-scroll.css" rel="stylesheet" type="text/css"> -->
</head>
...
<body>
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite>
							<img src="resources/images/customer-1.jpg" alt="Alberto Duncan">
							Alberto Duncan
						</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite>
							<img src="resources/images/customer-2.jpg" alt="Joana Silva">
							Joana Silva
						</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite>
							<img src="resources/images/customer-3.jpg" alt="Milton Chapman">
							Milton Chapman
						</cite>
                    </blockquote>
                </div>
                ...
                <div class="row">
                    <form method="post" action="mailer.php" class="contact-form">
                        <div class="row">
                            ...
                            if ($_GET['success'] == -1) {
                                echo "<div class=\"form-messages success\">Error! Please try again.</div>";
                            }
                            ?>
                        </div>
                        <div class="row">
    ...
    <script src="http://cdn.jsdelivr.net/g/selectivizr@1.0.3b,respond@1.4.2"></script>
    <script src="vendors/js/jquery.waypoints.min.js"></script>
    <!-- <script type="text/javascript" src="vendors/js/jquery.onepage-scroll.js"></script> -->
...
<!-- 
	<script>
	  $(document).ready(function(){
      $(".jv-main").onepage_scroll({
        sectionContainer: "section, header, footer",
